		...
		<div className="row">
			...
			<div className="col-md-offset-2 col-md-8 col-sm-12">
				<div className="section-title">
					<h1 className="wow fadeInUp" data-wow-delay="0.3s">Get in touch</h1>
					<p className="wow fadeInUp" data-wow-delay="0.6s">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet. Dolore magna aliquam erat volutpat.</p>
				</div>
				<div className="contact-form wow fadeInUp" data-wow-delay="1.0s">
					<form id="contact-form" method="post" action="#">
						...
						<div className="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8">
							<input name="submit" type="submit" className="form-control submit" id="submit" value="SEND MESSAGE"/>
						</div>
					</form>
				</div>
			</div>
	...
	<div className="container">
      ...
      <div className="col-md-4 col-sm-6">
        <h2>comila</h2>
          <div className="wow fadeInUp" data-wow-delay="0.3s">
             ...
             <p className="copyright-text">Copyright &copy; 2016 Your Company 
      ...
      <div className="col-md-4 col-sm-5">
        ...
        <ul className="social-icon">
          <li><a href="#" className="fa fa-facebook wow bounceIn" data-wow-delay="0.9s"></a></li>
          <li><a href="#" className="fa fa-twitter wow bounceIn" data-wow-delay="1.2s"></a></li>
          <li><a href="#" className="fa fa-behance wow bounceIn" data-wow-delay="1.4s"></a></li>
          <li><a href="#" className="fa fa-dribbble wow bounceIn" data-wow-delay="1.6s"></a></li>
        </ul>
      </div>
  ...
  <div className="modal-dialog">
      <div className="modal-content modal-popup">
        ...
        {/* <form action="#" method="post"> */}
          <input name="fullname" type="text" className="form-control" id="fullname" placeholder="Full Name"/>
          <input name="email" type="text" className="form-control" id="email" placeholder="Email Address"/>
          <input name="submit" type="submit" className="form-control" id="submit" value="Subscribe Now"/>
        {/* </form> */}
